...
const Header = () => {
  return (
    <div className="flex items-center p-4 justify-around text-muted-foreground gap-4 container mx-auto max-w-screen-xl">
      ...
      <nav className="hidden sm:flex gap-10">
        <Link
          href="/"
          className="text-purple-600 hover:text-muted-foreground font-medium "
        >
          Inicio
        </Link>
      ...
      <div className="flex gap-4 items-center">
        <Button className="dark:bg-purple-600 dark:text-foreground dark:hover:text-foreground bg-purple-600 dark:hover:bg-zinc-800">
